  ...
  switch(computerMove) {
    ...
    if(gameBoard[0][0] != moveTokenO && gameBoard[0][0] != moveTokenX) {
       ...
       System.out.println(gameBoard[0][0]);
        ...
        else if (gameBoard[2][1] == moveTokenO || gameBoard[2][1] == moveTokenX)
        gameLogic();
       break;
     case 2:
...
if(gameBoard[2][0] == moveTokenO && gameBoard[1][1] == moveTokenO && gameBoard[0][2] == moveTokenO){
  System.out.println("Congratulations! You win!");
  hasGameEnded = true;
...
if(gameBoard[2][0] == moveTokenX && gameBoard[1][1] == moveTokenX && gameBoard[0][2] == moveTokenX){
  System.out.println("CPU WINS! You lose.");
  hasGameEnded = true;
 }
}
